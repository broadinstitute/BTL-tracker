...
object MolecularBarcodes {
	...
	private val mbS504 = MolBarcode("AGAGTAGA","Datan")
	private val mbS505 = MolBarcode("GTAAGGAG","Tadid")
	private val mbS506 = MolBarcode("ACTGCATA","Copaw")
	private val mbS507 = MolBarcode("AAGGAGTA","Biniw")
	private val mbS508 = MolBarcode("CTAAGCCT","Ladel")
	private val mbS510 = MolBarcode("CGTCTAAT","Kolaf")
	private val mbS511 = MolBarcode("TCTCTCCG","Xolek")
	private val mbS513 = MolBarcode("TCGACTAG","Xicod")
	private val mbS515 = MolBarcode("TTCTAGCT","Zewil")
	private val mbS516 = MolBarcode("CCTAGAGT","Jodat")
	private val mbS517 = MolBarcode("GCGTAAGA","Piwan")
	private val mbS518 = MolBarcode("CTATTAAG","Lazad")
	private val mbS520 = MolBarcode("AAGGCTAT","Bipof")
	private val mbS521 = MolBarcode("GAGCCTTA","Nijow")
	private val mbS522 = MolBarcode("TTATGCGA","Zayen")

	private val mbSxx1 = MolBarcode("AACCTCTT","Belez")
	private val mbSxx2 = MolBarcode("AGTCACCT","Dohel")
	private val mbSxx3 = MolBarcode("CCTCTAAC","Jolac")
	private val mbSxx4 = MolBarcode("CTGAAGCT","Libil")
	private val mbSxx5 = MolBarcode("GGCAATAC","Reboc")
	private val mbSxx6 = MolBarcode("GAACGCTA","Nakew")
	private val mbSxx7 = MolBarcode("TTAGCCAG","Zaped")
	private val mbSxx8 = MolBarcode("TCTCGCGC","Xokep")
	private val mbSxx9 = MolBarcode("GCAGGTTG","Paray")
	private val mbSxx10 = MolBarcode("ATGAATTA","Fibow")
	private val mbSxx11 = MolBarcode("CGCATATT","Kefaz")
	private val mbSxx12 = MolBarcode("CAACTGAT","Halif")
	private val mbSxx13 = MolBarcode("GTCTGCAC","Teyec")
	private val mbSxx14 = MolBarcode("GCTAGCAG","Poded")
	private val mbSxx15 = MolBarcode("TAATCCGG","Waxer")
	private val mbSxx16 = MolBarcode("TGGTGCAT","Yiyef")
	private val mbSxx17 = MolBarcode("GAACTTCG","Nalok")
	private val mbSxx18 = MolBarcode("AGTAGGCA","Dodih")
	private val mbSxx19 = MolBarcode("GGAATACG","Rafak")
	private val mbSxx20 = MolBarcode("CAGCGATT","Hikaz")
	private val mbSxx21 = MolBarcode("TCATGTCT","Xayol")
	private val mbSxx22 = MolBarcode("CGACTCTC","Kalex")
	private val mbSxx23 = MolBarcode("TTCACAGA","Zecan")
	//Low Input Metagenomic
	private val mbSxx101 = MolBarcode("ATCTTCTC","Fezex")
	private val mbSxx102 = MolBarcode("CAGCTCAC","Hilec")
	private val mbSxx103 = MolBarcode("GGTTATCT","Rowol")
	private val mbSxx104 = MolBarcode("TCCGCATA","Xepaw")
	private val mbSxx105 = MolBarcode("TGCTTCAC","Yezec")
	private val mbSxx106 = MolBarcode("GCTTCCTA","Poxew")
	private val mbSxx107 = MolBarcode("GACCATCT","Nehol")
	private val mbSxx108 = MolBarcode("CTGGTATT","Litaz")
	private val mbSxx109 = MolBarcode("TTAATCAC","Zafec")
	private val mbSxx110 = MolBarcode("CGCGAATA","Kenaw")
	private val mbSxx111 = MolBarcode("GCTCACCA","Poheh")
	private val mbSxx113 = MolBarcode("ATCCTTAA","Felob")
	private val mbSxx114 = MolBarcode("TTCTTGGC","Zezip")
	private val mbSxx115 = MolBarcode("CATCACTT","Hohez")
	private val mbSxx116 = MolBarcode("CGAACTTC","Kacox")
	private val mbSxx117 = MolBarcode("GACATTAA","Nefob")
	private val mbSxx118 = MolBarcode("TTCACCTT","Zecez")
	private val mbSxx119 = MolBarcode("CCAATCTG","Jafey")
	private val mbSxx120 = MolBarcode("CGACAGTT","Kahiz")
	private val mbSxx25 = MolBarcode("ATCGACTG","Feney")
	private val mbSxx27 = MolBarcode("TACTCTCC","Wexoj")
	private val mbSxx28 = MolBarcode("TGACAGCA","Yahih")
	private val mbSxx29 = MolBarcode("GCAGGTTG","Paroy")
	private val mbSxx30 = MolBarcode("TTCCAGCT","Zehil")
	private val mbSxx31 = MolBarcode("TAGTTAGC","Wizap")
	private val mbSxx32 = MolBarcode("AGCGCTAA","Depob")
	private val mbSxx33 = MolBarcode("CGGTTCTT","Kizez")
	private val mbSxx34 = MolBarcode("TAGCATTG","Wihoy")
	private val mbSxx35 = MolBarcode("AATTCAAC","Boxac")
	private val mbSxx37 = MolBarcode("GCTCTCTT","Polez")
	private val mbSxx38 = MolBarcode("TGACTTGG","Yalor")
	private val mbSxx39 = MolBarcode("TATGGTTC","Worox")
	private val mbSxx40 = MolBarcode("CACTAGCC","Hewij")
	private val mbSxx42 = MolBarcode("CTACATTG","Lahoy")
	private val mbSxx43 = MolBarcode("GCGATTAC","Pifoc")
	private val mbSxx44 = MolBarcode("AATTGGCC","Boyij")
	private val mbSxx45 = MolBarcode("AATTGCTT","Boyez")
	private val mbSxx46 = MolBarcode("TTGGTCTG","Zitey")
	private val mbSxx47 = MolBarcode("CATCCTGG","Hojor")
	private val mbSxx48 = MolBarcode("GGATTAAC","Razac")
	private val mbSxx50 = MolBarcode("TCATTCGA","Xazen")
	private val mbSxx51 = MolBarcode("GTCCAATC","Tehax")
	private val mbSxx52 = MolBarcode("CTTGGTCA","Loroh")
	private val mbSxx53 = MolBarcode("CCAACGCT","Jacil")
	private val mbSxx54 = MolBarcode("TCCACTTC","Xecox")
	private val mbSxx55 = MolBarcode("AATCTCCA","Boleh")
	private val mbSxx57 = MolBarcode("CTGCTCCT","Lilel")
	private val mbSxx59 = MolBarcode("GCTGATTC","Ponox")
	private val mbSxx60 = MolBarcode("GAATCGAC","Naxic")
	private val mbSxx62 = MolBarcode("CACGATTC","Henox")
	private val mbSxx63 = MolBarcode("GCTCCGAT","Pojif")
	private val mbSxx64 = MolBarcode("ACAAGTCA","Cadoh")
	private val mbSxx65 = MolBarcode("GCTGCACT","Popal")
	private val mbSxx67 = MolBarcode("CTGTATTC","Liwox")
	private val mbSxx68 = MolBarcode("ATATCCGA","Faxen")
	private val mbSxx69 = MolBarcode("TTGTCCAT","Zixef")
	private val mbSxx70 = MolBarcode("AGTAAGTC","Dobix")
	private val mbSxx71 = MolBarcode("GAATATCA","Nawoh")
	private val mbSxx73 = MolBarcode("CCTGTCAT","Jotef")
	private val mbSxx74 = MolBarcode("GACGGTTA","Nerow")
	private val mbSxx75 = MolBarcode("CTATTAGC","Lazap")
	private val mbSxx76 = MolBarcode("TCCAACCA","Xebeh")
	private val mbSxx77 = MolBarcode("CTGGCTAT","Lipof")
	private val mbSxx78 = MolBarcode("ACTGGCTC","Corex")
	private val mbSxx79 = MolBarcode("CCATCACA","Jaxah")
	private val mbSxx81 = MolBarcode("CACTTCAT","Hezef")
	private val mbSxx82 = MolBarcode("CAAGCTTA","Hapow")
	private val mbSxx83 = MolBarcode("AGGTACCA","Diweh")
	private val mbSxx84 = MolBarcode("TCCATAAC","Xefac")
	private val mbSxx85 = MolBarcode("GTCCTCAT","Telef")
	private val mbSxx86 = MolBarcode("AGTACTGC","Docop")
	private val mbSxx87 = MolBarcode("CTTGAATC","Lonax")
	private val mbSxx88 = MolBarcode("CCAACTAA","Jacob")
	private val mbSxx89 = MolBarcode("AATACCAT","Bocef")
	private val mbSxx90 = MolBarcode("ACCTATGC","Cewop")
	private val mbSxx92 = MolBarcode("CTGACATC","Licax")
	private val mbSxx93 = MolBarcode("GCCACCAT","Pecef")
	private val mbSxx95 = MolBarcode("TGCTATTA","Yewow")
	private val mbSxx96 = MolBarcode("CTTCTGGC","Lolip")
	private val mbSxx98 = MolBarcode("TACTCCAG","Wexed")
	private val mbSxx99 = MolBarcode("ATCATACC","Fefaj")


	// Create i7 Nextera Molecular barcodes
	private val mbN701 = MolBarcode("TAAGGCGA","Waren")
	private val mbN702 = MolBarcode("CGTACTAG","Kocod")
	private val mbN703 = MolBarcode("AGGCAGAA","Dihib")
	private val mbN704 = MolBarcode("TCCTGAGC","Xeyap")
	private val mbN705 = MolBarcode("GGACTCCT","Ralel")
	private val mbN706 = MolBarcode("TAGGCATG","Wipay")
	private val mbN707 = MolBarcode("CTCTCTAC","Lexoc")
	private val mbN708 = MolBarcode("CAGAGAGG","Hidar")
	private val mbN709 = MolBarcode("GCTACGCT","Pocil")
	private val mbN710 = MolBarcode("CGAGGCTG","Karey")
	private val mbN711 = MolBarcode("AAGAGGCA","Bidih")
	private val mbN712 = MolBarcode("GTAGAGGA","Tanin")
	private val mbN714 = MolBarcode("GCTCATGA","Pohon")
	private val mbN715 = MolBarcode("ATCTCAGG","Fexar")
	private val mbN716 = MolBarcode("ACTCGCTA","Cokew")
	private val mbN718 = MolBarcode("GGAGCTAC","Rapoc")
	private val mbN719 = MolBarcode("GCGTAGTA","Piwiw")
	private val mbN720 = MolBarcode("CGGAGCCT","Kidel")
	private val mbN721 = MolBarcode("TACGCTGC","Wepop")
	private val mbN722 = MolBarcode("ATGCGCAG","Fiked")
	private val mbN723 = MolBarcode("TAGCGCTC","Wikex")
	private val mbN724 = MolBarcode("ACTGAGCG","Conik")
	private val mbN726 = MolBarcode("CCTAAGAC","Jobic")
	private val mbN727 = MolBarcode("CGATCAGT","Kaxat")
	private val mbN728 = MolBarcode("TGCAGCTA","Yedew")
	private val mbN729 = MolBarcode("TCGACGTC","Xicix")
	// Barcodes used for Housekeeping (plate 1)
	private val mbNxx1 = MolBarcode("ACTTCTTC","Coxox")
	private val mbNxx2 = MolBarcode("TGGTAACG","Yiwak")
	private val mbNxx3 = MolBarcode("TAGATCCT","Wifel")
	private val mbNxx4 = MolBarcode("CATCAGAC","Hohic")
	private val mbNxx5 = MolBarcode("TTACTGTC","Zalix")
	private val mbNxx6 = MolBarcode("GTGCGTAA","Tikob")
	private val mbNxx7 = MolBarcode("GGCATAGG","Refar")
	private val mbNxx8 = MolBarcode("CTATTCAA","Lezab")
	private val mbNxx9 = MolBarcode("CAAGGCGA","Haren")
	private val mbNxx10 = MolBarcode("CAGTTGGT","Hizit")
	private val mbNxx11 = MolBarcode("GACGCTAT","Nepof")
	private val mbNxx12 = MolBarcode("TCTGGACC","Xoraj")
	private val mbNxx13 = MolBarcode("AAGGCGAC","Bipic")
	private val mbNxx14 = MolBarcode("TGTTATAC","Yowoc")
	private val mbNxx15 = MolBarcode("CCTAGAAT","Jodaf")
	private val mbNxx16 = MolBarcode("TCAGCGAA","Xapib")
	// Barcodes used for Housekeeping (plate 2)
	private val mbNxx17 = MolBarcode("AATGCGTT","Bopiz")
	private val mbNxx18 = MolBarcode("GAGAGTTG","Nidoy")
	private val mbNxx19 = MolBarcode("GATTACAG","Nowed")
	private val mbNxx20 = MolBarcode("TGTGCTTA","Yopow")
	private val mbNxx21 = MolBarcode("AGAACATT","Dacaz")
	private val mbNxx22 = MolBarcode("TACCGCTG","Wekey")
	private val mbNxx23 = MolBarcode("TCCTGGTC","Xeyix")
	private val mbNxx24 = MolBarcode("CCTGGATA","Joraw")
	private val mbNxx25 = MolBarcode("ATACCTGT","Fajot")
	private val mbNxx26 = MolBarcode("AATGTTGG","Botor")
	private val mbNxx27 = MolBarcode("TCGACGGC","Xicip")
	private val mbNxx28 = MolBarcode("GGCAGATA","Redaw")
	private val mbNxx29 = MolBarcode("GTCTTAGT","Tezat")
	private val mbNxx30 = MolBarcode("GGAAGGCG","Radik")
	private val mbNxx31 = MolBarcode("GGCTAGGC","Rewip")
	private val mbNxx32 = MolBarcode("CAGCAGCA","Yeyey")
	// Barcodes used for TCR (P7 set for entire plate)
	private val mbNxx33 = MolBarcode("TTGAGCCT", "Zidel")
	private val mbNxx34 = MolBarcode("CCAGTTAG", "Jatod")
	// Barcodes ued for MiRNA
	private val mbNxx35 = MolBarcode("GCACACGA","Pahen")
	private val mbNxx36 = MolBarcode("TCTGGCGA","Xoren")
	private val mbNxx37 = MolBarcode("CATAGCGA","Hoden")
	private val mbNxx38 = MolBarcode("CAGGAGCC","Hinij")
	private val mbNxx39 = MolBarcode("TGTCGGAT","Yokif")
	private val mbNxx40 = MolBarcode("ATTATGTT","Fofiz")
	private val mbNxx41 = MolBarcode("CCTACCAT","Jocef")
	private val mbNxx42 = MolBarcode("TACTTAGC","Wezap")
	private val mbNxx43 = MolBarcode("AACAATGG","Bebor")
	private val mbNxx44 = MolBarcode("TATCTGCC","Wolij")
	private val mbNxx45 = MolBarcode("GACCTAAC","Nelac")
	private val mbNxx46 = MolBarcode("GGTCCAGA","Rojan")
	private val mbNxx47 = MolBarcode("CAACTCTC","Halex")
	private val mbNxx48 = MolBarcode("CATGCTTA","Hopow")
	private val mbNxx49 = MolBarcode("CGTTACCA","Koweh")
	private val mbNxx50 = MolBarcode("CTGTAATC","Liwax")
	//Low Input Metagenomic
	private val mbNxx731 = MolBarcode("AAGTAGAG","Biwid")
	private val mbNxx733 = MolBarcode("GCACATCT","Pahol")
	private val mbNxx734 = MolBarcode("TTCGCTGA","Zepon")
	private val mbNxx735 = MolBarcode("AGCAATTC","Debox")
	private val mbNxx736 = MolBarcode("CACATCCT","Hefel")
	private val mbNxx738 = MolBarcode("AAGGATGT","Binot")
	private val mbNxx739 = MolBarcode("ACACGATC","Cakax")
	private val mbNxx741 = MolBarcode("GTATAACA","Tawah")
	private val mbNxx742 = MolBarcode("TGCTCGAC","Yexic")
	private val mbNxx743 = MolBarcode("AACTTGAC","Bezic")
	private val mbNxx744 = MolBarcode("AGTTGCTT","Doyez")
	private val mbNxx745 = MolBarcode("TCGGAATG","Xinay")
	private val mbNxx747 = MolBarcode("TGTTCCGA","Yoxen")
	private val mbNxx748 = MolBarcode("AGGATCTA","Difew")
	private val mbNxx750 = MolBarcode("CCTATGCC","Jofij")
	private val mbNxx752 = MolBarcode("ATAGCGTC","Fapix")
	private val mbNxx754 = MolBarcode("ATTCTAGG","Folar")
	private val mbNxx755 = MolBarcode("CATGATCG","Honok")
	private val mbNxx757 = MolBarcode("GACAGTAA","Nedob")
	private val mbNxx759 = MolBarcode("TCGCCTTG","Xijoy")
	private val mbNxx761 = MolBarcode("GAAGAAGT","Nanat")
	private val mbNxx764 = MolBarcode("AGGTTATC","Dizax")
	private val mbNxx765 = MolBarcode("TTACGCAC","Zakec")
	private val mbNxx766 = MolBarcode("CCTTCGCA","Joxih")
	private val mbNxx767 = MolBarcode("AAGACACT","Bical")
	private val mbNxx768 = MolBarcode("ATTGTCTG","Fotey")
	private val mbNxx769 = MolBarcode("TCCAGCAA","Xedeb")
	private val mbNxx770 = MolBarcode("TAATGAAC","Wayac")
	private val mbNxx771 = MolBarcode("TCCTTGGT","Xezit")
	private val mbNxx772 = MolBarcode("GTCTGATG","Teyay")
	private val mbNxx773 = MolBarcode("GTCATCTA","Tefew")
	private val mbNxx774 = MolBarcode("TTGAATAG","Zibod")
	private val mbNxx775 = MolBarcode("TCTCGGTC","Xokix")
	private val mbNxx776 = MolBarcode("CAGCAAGG","Hihar")
	private val mbNxx777 = MolBarcode("GAACCTAG","Najod")
	private val mbNxx778 = MolBarcode("CCAGAGCT","Janil")
	private val mbNxx779 = MolBarcode("AACGCATT","Bepaz")
	private val mbNxx780 = MolBarcode("CCAACATT","Jacaz")
	private val mbNxx783 = MolBarcode("AATGTTCT","Botol")
	private val mbNxx784 = MolBarcode("CGCCTTCC","Keloj")
	private val mbNxx785 = MolBarcode("GACCAGGA","Nehin")
	private val mbNxx787 = MolBarcode("ACAGGTAT","Carof")
	private val mbNxx789 = MolBarcode("GCCGTCGA","Peten")
	private val mbNxx790 = MolBarcode("TAAGCACA","Wapah")
	private val mbNxx791 = MolBarcode("ACTAAGAC","Cobic")
	private val mbNxx792 = MolBarcode("CAGCGGTA","Hikiw")
	private val mbNxx793 = MolBarcode("GCCTAGCC","Pewij")
	private val mbNxx794 = MolBarcode("TATCCAGG","Wojar")
	private val mbNxx795 = MolBarcode("AGGTAAGG","Diwar")
	private val mbNxx796 = MolBarcode("ATTCCTCT","Fojol")
	private val mbNxx797 = MolBarcode("GTAACATC","Tacax")
	private val mbNxx798 = MolBarcode("TCGCTAGA","Xilan")
	private val mbNxx799 = MolBarcode("ATTATCAA","Fofeb")
	private val mbNxx800 = MolBarcode("CAATAGTC","Hawix")
	private val mbNxx801 = MolBarcode("GTCCACAG","Tehed")
	private val mbNxx802 = MolBarcode("TCTGCAAG","Xopad")
	private val mbNxx804 = MolBarcode("CTAACTCG","Lacok")
	private val mbNxx805 = MolBarcode("GAAGGAAG","Narad")
	private val mbNxx806 = MolBarcode("TGTAATCA","Yoboh")
	private val mbNxx807 = MolBarcode("ACAGTTGA","Caton")
	private val mbNxx808 = MolBarcode("CTATGCGT","Layet")
	private val mbNxx809 = MolBarcode("GACCGTTG","Nekoy")
	private val mbNxx810 = MolBarcode("TTGTCTAT","Zixof")
	private val mbNxx811 = MolBarcode("ACTGTATC","Cotax")
	private val mbNxx812 = MolBarcode("CTGCGGAT","Likif")
	private val mbNxx814 = MolBarcode("TTAATCAG","Zafed")
	private val mbNxx815 = MolBarcode("AGCATGGA","Defin")
	private val mbNxx816 = MolBarcode("CTGTGGCG","Liyik")
	private val mbNxx817 = MolBarcode("GATATCCA","Nofeh")
	private val mbNxx818 = MolBarcode("TTATATCT","Zawol")
	private val mbNxx819 = MolBarcode("AGGTCGCA","Dixih")
	private val mbNxx820 = MolBarcode("CTACCAGG","Lajar")
	private val mbNxx821 = MolBarcode("ACCAACTG","Cebey")
	private val mbNxx822 = MolBarcode("TGCAAGTA","Yebiw")
	private val mbNxx823 = MolBarcode("AGGTGCGA","Diyen")
	private val mbNxx824 = MolBarcode("CGCTATGT","Kewot")
	private val mbNxx825 = MolBarcode("GCCGCAAC","Pepac")
	private val mbNxx826 = MolBarcode("TGTAACTC","Yobex")
