...
/**/
object mainComponent extends BaseScalaTemplate[play.twirl.api.HtmlFormat.Appendable,Format[play.twirl.api.HtmlFormat.Appendable]](play.twirl.api.HtmlFormat) with play.twirl.api.Template2[String,Html,play.twirl.api.HtmlFormat.Appendable] {
...
"""),_display_(/*5.2*/main(title)/*5.13*/ {_display_(Seq[Any](format.raw/*5.15*/("""
    ...
    <script type="text/javascript">
        $(function() """),format.raw/*8.22*/("""{"""),format.raw/*8.23*/("""
            ...
            var componentTags = """"),_display_(/*12.35*/{Component.formKey + "." + Component.tagsKey}),format.raw/*12.80*/("""";
            $('#' + '"""),_display_(/*13.23*/Component/*13.32*/.addTag),format.raw/*13.39*/("""').click(function () """),format.raw/*13.60*/("""{"""),format.raw/*13.61*/("""
                """),format.raw/*14.17*/("""$('<div><dl id="tags_' + i + '_tag_field">' +
                  ...
                  '<dd><input type="text" id="tags_' + i + '_tag" name="' + componentTags + '[' + i + ']."""),_display_(/*16.107*/ComponentTag/*16.119*/.tagKey),format.raw/*16.126*/("""" value=""/></dd>' +
                  '<dd class="info">Required</dd>' +
                  '</dl>' +
                  '<dl id="tags_' + i + '_value_field">' +
                  '<dt><label for="tags_' + i + '_value">Value</label></dt>' +
                  '<dd><textarea id="tags_' + i + '_value" name="' + componentTags + '[' + i + ']."""),_display_(/*21.100*/ComponentTag/*21.112*/.valueKey),format.raw/*21.121*/(""""></textarea></dd>' +
...
""")))}/*32.2*/{_display_(_display_(/*32.4*/content))}),format.raw/*32.12*/("""
...
"""))}
  ...
  def ref: this.type = this
              ...
              /*
                  -- GENERATED --
                  DATE: Tue Feb 10 22:06:21 EST 2015
                  SOURCE: /Users/nnovod/play/tracker/app/views/mainComponent.scala.html
                  HASH: e875089a0b2a451dd408ae58e1b5da394d4c782f
                  MATRIX: 518->1|686->31|713->85|740->87|759->98|798->100|829->105|905->155|919->161|968->190|1055->250|1083->251|1123->264|1164->279|1204->299|1363->431|1429->476|1481->501|1499->510|1527->517|1576->538|1605->539|1650->556|1905->783|1927->795|1956->802|2323->1141|2345->1153|2376->1162|2469->1228|2487->1237|2515->1244|2650->1351|2679->1352|2753->1399|2771->1408|2799->1415|2842->1430|2871->1431|2916->1448|3018->1522|3047->1523|3085->1534|3114->1535|3149->1552|3178->1554|3209->1562
                  LINES: 19->1|23->1|24->4|25->5|25->5|25->5|26->6|26->6|26->6|26->6|28->8|28->8|29->9|29->9|29->9|32->12|32->12|33->13|33->13|33->13|33->13|33->13|34->14|36->16|36->16|36->16|41->21|41->21|41->21|42->22|42->22|42->22|45->25|45->25|46->26|46->26|46->26|46->26|46->26|47->27|49->29|49->29|50->30|50->30|52->32|52->32|52->32
                  -- GENERATED --
              */
